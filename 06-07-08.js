...
function crearClasePersona() {
  class Persona {
    ...
    addFriend(nombre, edad) {
      ...
      // Tu código aca:
      // var instanciaPersona = new Persona(nombre, edad, [], []);
    ...
    getFriends() {
      ...
      // Tu código aca:
      return this.amigos.map(nom => nom.nombre);
    }
    ...
    getHobbies() {
      ...
      // Tu código aca:
      // this.map(hobbie => hobbie[this.hobbies]);
      // return array.map(valor => valor[propiedad]);
      return this.hobbies;
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var edades = this.amigos.map(vEdad => vEdad.edad);
